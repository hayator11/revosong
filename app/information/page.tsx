      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <section style={{ background: "rgba(255,20,147,0.08)", border: "1px solid rgba(255,20,147,0.2)", borderRadius: "16px", padding: "28px 24px", marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.8)", lineHeight: 1.9, marginBottom: "20px" }}>
            <strong>15年の信念を形にした活動へのアクセス</strong>——おのくんの公式ページと、レボリストLabから展開するすべてのプロジェクト、そして代表 @hayator の発信源へ。
          </p>

          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "20px" }}>
            <a href="https://onokun.com/" target="_blank" rel="noopener noreferrer" style={{ padding: "14px 16px", background: "rgba(255,20,147,0.15)", border: "1px solid rgba(255,20,147,0.3)", borderRadius: "8px", color: "#ff1493", textDecoration: "none", fontSize: "13px", fontWeight: 600, textAlign: "center" }}>
              👉 おのくん公式サイト
            </a>
            <a href="https://hayator.socialimagine.com/" target="_blank" rel="noopener noreferrer" style={{ padding: "14px 16px", background: "rgba(138,43,226,0.15)", border: "1px solid rgba(138,43,226,0.3)", borderRadius: "8px", color: "#8a2be2", textDecoration: "none", fontSize: "13px", fontWeight: 600, textAlign: "center" }}>
              📝 @hayator ブログ
            </a>
          </div>
        ...
        <section style={{ marginBottom: "48px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "12px" }}>
            ...
            <div style={{ border: "1px solid rgba(0,191,255,0.3)", borderRadius: "12px", background: "rgba(0,191,255,0.05)", padding: "16px" }}>
              <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#00bfff", marginBottom: "10px" }}>🎓 レボハット（Hat Model Academy）</h3>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.75)", lineHeight: 1.7, marginBottom: "12px" }}>
